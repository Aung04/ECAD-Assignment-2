...
<header>
    ...
    <a href="cart.php" class="cart-btn">🛒 View Cart (<span id="cart-count"><?php echo isset($_SESSION['cart']) ? count($_SESSION['cart']) : 0; ?></span>)</a>
</header>
                    ...
                    <div class="price-container">
                        <?php if ($product['Offered'] == 1): ?>
                            ...
                            <p class="price"><del>$<?php echo number_format($product['Price'], 2); ?></del> 
                               <strong>$<?php echo number_format($product['OfferedPrice'], 2); ?></strong></p>
                        <?php else: ?>
